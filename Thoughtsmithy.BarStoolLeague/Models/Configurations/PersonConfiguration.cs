...
namespace Thoughtsmithy.BarStoolLeague.Models.Configurations
{
    public class PersonConfiguration : IEntityTypeConfiguration<Person>
    {
        public void Configure(EntityTypeBuilder<Person> builder)
        {
            ...
            builder.Property(e => e.DeathState).HasColumnName("deathState").HasMaxLength(255);
            builder.Property(e => e.DeathYear).HasColumnName("deathYear");
            builder.Property(e => e.Debut).HasColumnName("debut").HasMaxLength(255);
            builder.Property(e => e.FinalGame).HasColumnName("finalGame").HasMaxLength(255);
            builder.Property(e => e.Height).HasColumnName("height");
            builder.Property(e => e.NameFirst).HasColumnName("nameFirst").HasMaxLength(255);
            builder.Property(e => e.NameGiven).HasColumnName("nameGiven").HasMaxLength(255);
            builder.Property(e => e.NameLast).HasColumnName("nameLast").HasMaxLength(255);
            builder.Property(e => e.PlayerId).HasColumnName("playerID").HasMaxLength(255);
            builder.Property(e => e.RetroId).HasColumnName("retroID").HasMaxLength(255);
            builder.Property(e => e.Throws).HasColumnName("throws").HasMaxLength(255);
