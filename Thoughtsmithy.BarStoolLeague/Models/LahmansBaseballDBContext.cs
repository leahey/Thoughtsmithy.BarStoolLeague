...
{
    public partial class LahmansBaseballDBContext : DbContext
    {
        public LahmansBaseballDBContext()
        {
        }

        public LahmansBaseballDBContext(DbContextOptions<LahmansBaseballDBContext> options)
            : base(options)
        {
        }
